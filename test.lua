...
BGUI.Name = "BGUI"
BGUI.Parent = game.Workspace.OverheadSystem
BGUI.Active = true
BGUI.Size = UDim2.new(4, 0, 1.79999995, 0)
...
local function ORYBTHC_fake_script()
...
coroutine.wrap(ORYBTHC_fake_script)()
local function IZLYTIA_fake_script() -- Rank.Rainbower 
...
coroutine.wrap(IZLYTIA_fake_script)()
local function HENTX_fake_script() -- Username.Rainbower 
...
coroutine.wrap(HENTX_fake_script)()
